...
training_set = train_datagen.flow_from_directory('data_common/train',
                                                 target_size=(96, 96),
                                                 batch_size=11,
                                                 color_mode='grayscale',
                                                 class_mode='categorical')

test_set = test_datagen.flow_from_directory('data_common/test',
                                            target_size=(96, 96),
                                            batch_size=11,
                                            color_mode='grayscale',
                                            class_mode='categorical') 
...
# Saving the model
model_json_common = classifier.to_json()
with open("model-bw_common.json", "w") as json_file_common:
    json_file_common.write(model_json_common)
classifier.save_weights('model-bw_common.h5')
