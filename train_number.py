...
# Saving the model
model_json_number = classifier.to_json()
with open("model-bw_number.json", "w") as json_file_number:
    json_file_number.write(model_json_number)
classifier.save_weights('model-bw_number.h5')
