...
def run1():
    ...
    os.system('python predict_number.py')
    
def run2():
    print("Collect Data Called")
    os.system('python collect-data_number.py')
    
def run3():
    print("Train Number Called")
    os.system('python train_number.py')    



B1= Button(root, text ="Predict Number",bg="black",fg="white",width=20,height=2,command = run1)
...
label= Label(root,text="Number Prediction",width=23,height=1)
