...
training_set = train_datagen.flow_from_directory('data_alphabet/train',
                                                 target_size=(96, 96),
                                                 batch_size=27,
                                                 color_mode='grayscale',
                                                 class_mode='categorical')

test_set = test_datagen.flow_from_directory('data_alphabet/test',
                                            target_size=(96, 96),
                                            batch_size=27,
                                            color_mode='grayscale',
                                            class_mode='categorical') 
classifier.fit_generator(
        ...
        epochs=27,#number of terations 
        validation_data=test_set,
        validation_steps=31)# No of images in test set
