...
def run1():
    ...
    os.system('python predict_alphabet.py')
    
def run2():
    print("Collect A-Z called")
    os.system('python collect-data_alphabet.py')
    
def run3():
    print("Train A-Z")
    os.system('python train_alphabet.py')    
...
label= Label(root,text="A-Z Prediction",width=23,height=1)
